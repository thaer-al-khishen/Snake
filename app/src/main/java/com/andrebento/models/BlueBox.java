...
//An item that the user consumes to make the snake increase in size by 1 while keeping the same score
public class BlueBox {private Bitmap image;
    private int posX, posY;

    public BlueBox(Context context) {
        image = Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.bluegiftbox),
